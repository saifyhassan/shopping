...
import {getusers} from "./wishlistapi"
const initial={
    image:"",
    discription:"",
    name:"",
...
function Wishlist(){
    ...
    return(
        <div className="row container-fluid">
                        ...
                        <div className="col-md-12">
                                ...
                                <div className="row">
                                      ...
                                      <div className="col-md-4">
                                           <p style={{marginTop:"-187px",marginLeft:"px",fontSize:"50px",fontFamily:"serif"}}><b>Wish List</b> </p> 
                                      </div> 
                        ...
                        <div className="row" style={{ marginTop: "210px",marginBottom:"25px" }}>
                                ...
                                <div className="col-md-2">
                                        <h6 className="shoppingcart1">Name</h6>
                                </div>

                                <div className="col-md-1">
                                        <h6 style={{marginLeft:"-60px"}} className="shoppingcart1">Price</h6>
                                </div>
                                {/* <div className="col-md-1">
                                        <h5><input type="number" style={{width:"55px"}}/></h5>
                                </div> */}
                                <div className="col-md-2">
                                        <h6 className="shoppingcart1">Stock</h6>
                                </div>
                    ...
                    <form action="" method="post">
                        <div className="row">
                                ...
                                <div className="col-md-2">
                                <input type="text" className="card-text " style={{ marginTop: "58px", marginLeft: "-16px", fontSize: "20px", fontFamily: "serif", color: "#506172",width:"273px", border:"none" }} name="name" value={user.name} onChange={(e)=>{fetchvalue(e)}}/>
                                        {/* <h6 className="shoppingcart1 sc1">Cap</h6> */}
                                </div>

                                <div className="col-md-1">
                                <input type="text" class="card-text" style={{ marginTop: "58px", marginLeft: "-78px", fontSize: "20px", fontFamily: "serif", color: "#506172",width:"273px",border:"none" }} name="price" value={user.price} onChange={(e)=>{fetchvalue(e)}}/>

                                        {/* <h6 style={{marginLeft:"-60px"}} className="shoppingcart1 sc1">$320.00</h6> */}
                                </div>
                                {/* <div className="col-md-1">
                                     <input type="number" style={{width:"55px",marginTop:"59px"}}/>
                                </div> */}
                                <div className="col-md-1">
                                <textarea  id="" cols="18"  class="card-text " style={{ marginTop: "49px", marginLeft: "-23px", fontSize: "25px",color: "#506172",width:"273px",border:"none",height:"45px" }} name="discription" value={user.discription} onChange={(e)=>{fetchvalue(e)}}></textarea>

                                        {/* <h6 className="shoppingcart1 sc1">Available</h6> */}
                                </div>
                        ...
                        <div className="row">
                                ...
                                <div className="col-md-2">
                                        <h6 className="shoppingcart1 sc1">Shirt</h6>
                                </div>

                                <div className="col-md-1">
                                        <h6 style={{marginLeft:"-60px"}} className="shoppingcart1 sc1">$720.00</h6>
                                </div>
                                {/* <div className="col-md-1">
                                    <input type="number" style={{width:"55px",marginTop:"59px"}}/>
                                </div> */}
                                <div className="col-md-1">
                                        <h6 className="shoppingcart1 sc1">Out Of Stock</h6>
                                </div>
